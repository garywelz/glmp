...
META = os.path.join(BASE, "q2_metadata.json")
DEDUPE = os.path.join(BASE, "q2_dedupe.json")
OUT = os.path.join(BASE, "q2_scored.json")
MODEL = "text-embedding-3-small"
DIMS = 1536
QUESTION_TEXT = "For which E. coli regulatory circuits does the literature provide activator binding-site evidence strong enough to build a PWM from?"
