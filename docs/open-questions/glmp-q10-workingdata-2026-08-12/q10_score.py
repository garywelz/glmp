...
META = os.path.join(BASE, "q10_metadata.json")
DEDUPE = os.path.join(BASE, "q10_dedupe.json")
OUT = os.path.join(BASE, "q10_scored.json")
MODEL = "text-embedding-3-small"
DIMS = 1536
QUESTION_TEXT = "What computational methods infer regulatory network structure from data, and how are the inferred networks validated?"
