...
| H2: Grammar-Aware Advantage | <span class="verdict verdict-partial">Tested; Not Supported</span>      | CellOracle case study (Section 8.7): grammar advantage negative on eight benchmark TFs. TRRUST propagation baseline (Section 8.8): Class III mean *r* below Class I; meta-analysis C3−C1 = −0.16 vs. ≈−0.05 for typical blind methods. Topology and literature GRN alone do not outperform grammar-blind scores here. |
